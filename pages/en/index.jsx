...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
  ...
  gtag('config', 'G-027PSJQNC4');`,
        ...
        <title>WebDesigns | WebSites | SEO & SEA | WebFixxers</title>
        <script
          dangerouslySetInnerHTML={{
        ...
        <meta
          name="description"
          content="We make it quick & easy to get your business online. We provide- 1) Best designs. 2) SEO & SEA support. 3) Ecommerce with Ecwid & Custom made."
        />
      </Head>
...
export async function getStaticProps() {
  ...
  try {
    let res = await fetch(
      "https://webfixxers-cms.herokuapp.com/getData?page=home&lang=en"
    );
    res = await res.json();

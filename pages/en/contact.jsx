...
'https://www.googletagmanager.com/gtm.js?id='+i+dl;f.parentNode.insertBefore(j,f);
        ...
        />
        <title>Get website as per your budget.</title>
      ...
      <ContactElement text={props.content}></ContactElement>
    </>
  );
};
...
export async function getStaticProps() {
  ...
  try {
    let res = await fetch(
      "https://webfixxers-cms.herokuapp.com/getData?page=contact&lang=en"
    );
    res = await res.json();
